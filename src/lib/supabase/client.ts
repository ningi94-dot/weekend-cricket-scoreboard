...
type PlayerRow = { id: string; name: string; batting_style: string; bowling_style: string; player_type: PlayerType | null; profile_id: string | null; created_by: string | null; created_at: string; updated_at: string };
...
type MatchRow = { id: string; team_a_name: string; team_b_name: string; match_date: string; start_time: string | null; location: string; overs_per_innings: number; status: MatchStatus; toss_winner: string | null; toss_decision: "bat" | "bowl" | null; winner: string | null; player_of_match_id: string | null; created_by: string | null; started_at: string | null; is_test: boolean; joker_enabled: boolean; joker_player_id: string | null; created_at: string; updated_at: string };
type PendingScoringAction = "incoming_batter" | "next_bowler";
type InningsRow = { id: string; match_id: string; batting_team_side: "a" | "b"; innings_number: number; status: InningsStatus; target_runs: number | null; striker_id: string | null; non_striker_id: string | null; bowler_id: string | null; pending_action: PendingScoringAction | null; pending_dismissed_player_id: string | null; pending_previous_bowler_id: string | null; pending_completed_over: number | null; started_at: string | null; completed_at: string | null };
...
export type Database = {
  public: {
    Tables: {
      ...
      players: { Row: PlayerRow; Insert: { id?: string; profile_id?: string | null; name: string; batting_style: string; bowling_style: string; player_type?: PlayerType | null; created_by?: string | null }; Update: { name?: string; batting_style?: string; bowling_style?: string; player_type?: PlayerType | null }; Relationships: [] };
      matches: { Row: MatchRow; Insert: { id?: string; team_a_name: string; team_b_name: string; match_date: string; start_time?: string | null; location: string; overs_per_innings: number; status?: MatchStatus; created_by?: string | null; is_test?: boolean; joker_enabled?: boolean; joker_player_id?: string | null }; Update: Partial<MatchRow>; Relationships: [] };
      ...
      innings: { Row: InningsRow; Insert: { id?: string; match_id: string; batting_team_side: "a" | "b"; innings_number: number; status?: InningsStatus; target_runs?: number | null; striker_id?: string | null; non_striker_id?: string | null; bowler_id?: string | null; pending_action?: PendingScoringAction | null; pending_dismissed_player_id?: string | null; pending_previous_bowler_id?: string | null; pending_completed_over?: number | null; started_at?: string | null; completed_at?: string | null }; Update: Partial<InningsRow>; Relationships: [] };
